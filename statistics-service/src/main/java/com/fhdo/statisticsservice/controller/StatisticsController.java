...
//
// @PostMapping("/bookings/filter")
// public BookingSummaryResponseDTO getFilteredBookings(@RequestBody
// BookingFilterRequestDTO request) {
...
////
//// @GetMapping("/init")
//// public ResponseEntity<String> initializeStatistics(@RequestParam String
// ownerId) {
