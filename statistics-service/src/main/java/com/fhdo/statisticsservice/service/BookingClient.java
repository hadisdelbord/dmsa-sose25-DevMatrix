...
////
//////********//
////    public List<BookingDTO> getBookingsByOwner(String ownerId) {
////            String url = "http://booking-service/api/bookings/by-owner/" + ownerId;
////            ResponseEntity<BookingDTO[]> response = restTemplate.getForEntity(url, BookingDTO[].class);
...
//        List<BookingDTO> fakeBookings = new ArrayList<>();
//
//        fakeBookings.add(new BookingDTO("123","station1", 20.0, 0.4, "COMPLETED", 50.0,
//                LocalDateTime.now().minusDays(1), "Alice"));
//        fakeBookings.add(new BookingDTO("123","station2", 15.0, 0.5, "COMPLETED", 30.0,
//                LocalDateTime.now().minusDays(10), "Bob"));
//        fakeBookings.add(new BookingDTO("124","station3", 25.0, 0.5, "CANCELLED", 0.0,
//                LocalDateTime.now().minusMonths(2), "Charlie"));
//
//        return fakeBookings;
//    }
//}
