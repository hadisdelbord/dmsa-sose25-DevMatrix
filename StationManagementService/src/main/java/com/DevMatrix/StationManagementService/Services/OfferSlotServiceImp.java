...
public class OfferSlotServiceImp implements OfferSlotService {
    ...
    public OfferSlotServiceImp(OfferSlotRepository offerSlotRepository, OfferSlotMapper offerSlotMapper,
 ...
 @Override
    ...
    public Optional<OfferAndStationDto> GetOfferWithStationById(long offerId) {
        var offerslotDto = _offerSlotRepository.GetOfferSlotsWithStationById(offerId)
                .map(_OfferSlotMapper::toDtoWithStation);
        ;
        return offerslotDto;
    }
